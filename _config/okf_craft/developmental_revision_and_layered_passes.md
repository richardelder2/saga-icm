...
keywords: [revision, editing, macro edit, line edit, developmental editing, beta triage, the cut pass]
---
...
```mermaid
graph TD
    P1[Pass 1: Macro Architecture & Reader Promise] --> P2[Pass 2: Character Agency & Relational Dynamics]
    P2 --> P3[Pass 3: Scene Mechanics & Value Shifts]
    P3 --> P4[Pass 4: Line Compression & Acoustic Polish]
```
